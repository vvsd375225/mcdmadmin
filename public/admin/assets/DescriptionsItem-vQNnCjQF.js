import{a as e}from"./Tag-DttUalMn.js";import{t}from"./get-slot-6kXJmSMP.js";import{Et as n,Fr as r,Ir as i,Mr as a,Nr as o,Or as s,Pr as c,di as l,ei as u,j as d,jr as f,kr as p,li as m,nr as h,on as g,sn as _,xn as v}from"./index-QEQuLFiJ.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=s([p(`descriptions`,{fontSize:`var(--n-font-size)`},[p(`descriptions-separator`,`
