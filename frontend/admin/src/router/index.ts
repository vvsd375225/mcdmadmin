...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai/tiers', name: 'AiTiers', component: () => import('@/views/ai/tiers.vue') },
      ...
      { path: 'payment/result', name: 'PaymentResult', component: () => import('@/views/payment/result.vue') },
      { path: 'payment/orders', name: 'PaymentOrders', component: () => import('@/views/payment/orders.vue') },
